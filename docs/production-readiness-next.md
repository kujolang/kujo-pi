...
|---:|---|---|---:|---|
| 1 | Configure and rehearse npm trusted publishing | External release | completed for `v0.3.2` | Protected release run `33278436311` published the verified tarball to npm and created the matching GitHub release with provenance. |
...
| 5 | Supported-platform matrix | Compatibility | implemented and passing | CI and release workflows cover Linux, macOS, and Windows with Node 22 and 24; main CI run `33278382278` and release run `33278436311` passed all six cells. |
...
| 10 | Supply-chain attestations | Supply chain | implemented and released | Release `v0.3.2` includes the checksum, CycloneDX SBOM, verification record, and GitHub provenance; Dependency graph is enabled. |
